...
export default function Phase1({ onProceed }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-100 via-teal-200 to-green-300 flex flex-col items-center justify-center px-4">
      <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-md text-center">
        <h1 className="text-3xl font-extrabold text-teal-800 mb-2">OTSRegister</h1>
        <p className="text-sm text-gray-500 mb-6">
          Recover faster. Report smarter.
        </p>
